...
public class SearchPageStep extends BasePageStep {
    ...
    /**
     * check that entered city and city displayed in input search field are the same
     *
     * @param enteredCity city which was enter in input field
     * @return true if they equals, false if they are not
     */
    public boolean isEnteredCityEqualsShownInInputFieldCity(String enteredCity) {
        return enteredCity.equals(searchPage.getCityFromInputField());
    }
